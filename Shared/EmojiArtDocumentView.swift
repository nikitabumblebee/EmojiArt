...
//  EmojiArt
//
//  Created by nikita.shmelev on 21.10.2021.
//
...
struct EmojiArtDocumentView: View {
    ...
    var documentBody: some View {
        GeometryReader { geometry in
            ...
            .compactableToolbar {
                AninmatedActionButton(title: "Paste Background", systemImage: "doc.on.clipboard") {
                    pasteBackground()
                }
                if Camera.isAvailable {
                    AninmatedActionButton(title: "Take Photo", systemImage: "camera") {
                        backgroundPicker = .camera
                    }
                }
                if PhotoLibrary.isAvailable {
                    AninmatedActionButton(title: "Search Photos", systemImage: "photo") {
                ...
                if let undoManager = undoManager {
                    if undoManager.canUndo {
                        AninmatedActionButton(title: undoManager.undoActionName, systemImage: "arrow.uturn.backward") {
                            undoManager.undo()
                        }
                    }
                    if undoManager.canRedo {
                        AninmatedActionButton(title: undoManager.redoActionName, systemImage: "arrow.uturn.forward") {
                            undoManager.redo()
                        }
                    }
                }
